(function () {
	 ...
	 * @const
	 */
	var AZURE_MOBILE_SERVICES_KEY = 'LUOuMmtHlxJlGQsgPezjxzXtspiCli21';
	 ...
	 * @const
	 */
	var AZURE_MOBILE_SERVICES_ADDRESS = 'https://todo-ex.azure-mobile.net/';
	...
	function AzureStorage($resource, guidGenerator) {
		...
		this.toDoItem = $resource(azureMobileServicesTableAddress, { id: '@id' }, {
			...
			'completeAll': {
				url:AZURE_MOBILE_SERVICES_ADDRESS + 'api/compleall',
				method: 'POST',
				headers: headers
			}
		});
  ...
  /**
   * Marks all the task as completed
   */
	AzureStorage.prototype.completeAll = function () {
		return this.toDoItem.completeAll();
	};
})();